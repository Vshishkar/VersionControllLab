...
public class PooledConnection implements Connection{
     ...
     public void close() throws SQLException {
         ...
         BlockingQueue<Connection> givenAwayConQueue = ConnectionPool.getInstanse().getGivenAwayConQueue();	
         ...
         BlockingQueue<Connection> connectionQueue = ConnectionPool.getInstanse().getConnectionQueue();
